...
class DoublyLinkedList:
    ...
    def __init__(self, L = None):
        ...
        for e in L[1: ]:
            ...
            node.next_node.previous_node = node     # !!! Answer
            node = node.next_node
    ...
    def duplicate(self):
        ...
        while node:
            ...
            node_copy.next_node.previous_node = node_copy  # !!! Answer
    ...
    def reverse(self):
        ...
        last_node.previous_node = None      # !!1 Answer
        node.next_node = None
        self.reverse()
        last_node.next_node = self.head
        self.head.previous_node = last_node     # !!1 Answer
        self.head = last_node
    ...
    def append(self, value):
        ...
        node.next_node.previous_node = node     # !!1 Answer
    ...
    def insert_value_at(self, value, index):
        ...
        if index <= 0:
            ...
            if self.head:
                self.head.previous_node = new_node      # !!1 Answer
            self.head = new_node
            return
        if not self.head:
            self.head = new_node
